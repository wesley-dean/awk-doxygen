...
## or repair dependencies; callers prepare the stable documentation dependencies
## separately and may substitute current-source or exact-release AWK filter bytes.
docs-canary:
